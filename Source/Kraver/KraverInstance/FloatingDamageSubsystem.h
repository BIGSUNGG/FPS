...
#include "FloatingDamageSubsystem.generated.h"

/**
 * 
 */
UCLASS()
class KRAVER_API UFloatingDamageSubsystem : public UGameInstanceSubsystem
{
	GENERATED_BODY()
public:
	UFloatingDamageSubsystem();
